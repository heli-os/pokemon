...
pokemon pokemonBook[15] = {
	// 이상해씨, 이상해풀, 이상해꽃
	{ 1,  "Bulbasaur",  POKEMON_TYPE_GRASS | POKEMON_TYPE_POISON, 1, 110, 110, 20, 10 ,5},
	{ 2,  "Ivysaur",    POKEMON_TYPE_GRASS | POKEMON_TYPE_POISON, 1, 220, 220, 30, 15 ,7},
	{ 3,  "Venusaur",   POKEMON_TYPE_GRASS | POKEMON_TYPE_POISON, 1, 385, 385, 44, 22 ,10},
	// 파이리, 리자드, 리자몽
	{ 4,  "Charmander", POKEMON_TYPE_FIRE						, 1,  90,  90, 24,  8 ,5},
	{ 5,  "Charmeleon", POKEMON_TYPE_FIRE						, 1, 180, 180, 36, 12 ,7},
	{ 6,  "Charizard",  POKEMON_TYPE_FIRE | POKEMON_TYPE_FLYING , 1, 315, 315, 53, 18 ,10},
	// 꼬부기, 어니부기, 거북왕
	{ 7,  "Squirtle",   POKEMON_TYPE_WATER, 1, 95, 22, 9 ,5},
	{ 8,  "Wartortle",  POKEMON_TYPE_WATER, 1, 190, 33, 14 ,7},
	{ 9,  "Blastoise",  POKEMON_TYPE_WATER, 1, 332, 49, 20 ,10},
	// 구구, 피죤, 피죤투
	{ 10, "Pidgey",     POKEMON_TYPE_NORMAL | POKEMON_TYPE_FLYING, 1,  93,  93, 23,  8 ,9},
	{ 11, "Pidgeotto",  POKEMON_TYPE_NORMAL | POKEMON_TYPE_FLYING, 1, 186, 186, 35, 12 ,13},
	{ 12, "Pidgeot",    POKEMON_TYPE_NORMAL | POKEMON_TYPE_FLYING, 1, 325, 325, 51, 18 ,18},
	// 꼬렛
	{ 13, "Rattata",    POKEMON_TYPE_NORMAL, 1, 83, 83, 17, 15 ,8},
	// 피카츄, 라이츄
	{ 14, "Pikachu",    POKEMON_TYPE_ELECTRIC, 1, 105, 105, 22,  9,  6},
	{ 15, "Raichu",     POKEMON_TYPE_ELECTRIC, 1, 240, 240, 51, 21, 14},
};
...
void catchingPokemon(int pokemonId) {
	for (int i = 0; i < 6; i++) {
		...
		myPokemonList[i] = pokemonBook[pokemonId];
